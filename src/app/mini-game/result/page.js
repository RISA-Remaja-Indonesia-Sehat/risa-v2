...
const postScoreToAPI = async (data) => {
  ...
  const scoreData = {
    ...
    correctAnswers:
      data.gameType === "memory" ? data.matchedCount : data.correct,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {/* Artikel 1: HIV */}
              <Link
                href="/article/1" // Ganti dengan URL artikel sesungguhnya
              ...
              {/* Artikel 2: Seks */}
              <Link
                href="/article/2" // Ganti dengan URL artikel sesungguhnya
              ...
              <Link
                href="/article/3" // Ganti dengan URL artikel sesungguhnya
                className="group block transition duration-300 transform hover:translate-y-[-8px] shadow-xl hover:shadow-pink-200/50 rounded-xl overflow-hidden bg-white border border-gray-100"
              >
                <div className="p-4 flex flex-col h-full">
                  <div className="h-40 w-full relative mb-3">
