...
export default function ResultPage() {
    ...
    useEffect(() => {
        ...
        // Animasi GSAP
        setTimeout(() => {
            gsap.to("#score-container", { scale: 1, opacity: 1, duration: 1.2, ease: "expo.out", boxShadow: "0px 25px 50px -12px rgba(236, 72, 153, 0.4)" });
    ...
    const handleDownloadResult = useCallback(() => {
        ...
        html2canvas(resultRef.current, {
            ...
            windowHeight: document.documentElement.offsetHeight, scale: 3, 
        })
            .then((canvas) => {
