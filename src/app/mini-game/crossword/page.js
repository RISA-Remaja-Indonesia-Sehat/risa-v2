...
import useFullscreenStore from "@/app/store/useFullscreenStore";
    ...
    const fetchCrossword = async () => {
      try {
        const response = await fetch(
          "https://server-risa.vercel.app/api/crossword/generate"
        );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-yellow-50 p-3 md:p-4">
      <div className="max-w-6xl mx-auto sm:p-4">
        ...
        <h1 className="text-2xl md:text-4xl text-center font-bold text-pink-600 mb-1 md:mb-2">
          Teka-Teki Silang
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="bg-white p-3 md:p-4 rounded-xl shadow-md border-2 border-pink-200">
              <h3 className="font-bold text-pink-600 mb-2 md:mb-3 text-sm md:text-base">
                Mendatar
              </h3>
