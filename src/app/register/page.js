    ...
    <div className="flex min-h-screen flex-col bg-white lg:flex-row">
      <div className="relative hidden flex-1 items-center justify-center bg-[#ffe6f1] lg:flex">
        <div className="relative mx-auto w-full max-w-2xl px-12 py-16">
          <Image src="/image/register.png" alt="Ilustrasi remaja mendaftar aplikasi RISA" width={720} height={720} priority className="h-full w-full object-cover" />
        </div>
      </div>

      <div className="flex w-full flex-col justify-center px-6 py-12 sm:px-12 lg:max-w-xl lg:overflow-y-auto lg:px-16">
        <div className="mx-auto w-full max-w-md space-y-8 pb-8 lg:pb-12">
          ...
          <form className="space-y-5">
            <label className="block">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm shadow-sm transition focus-within:border-pink-300 focus-within:ring-2 focus-within:ring-pink-100">
                ...
                <input type="text" required placeholder="Username" className="w-full border-0 bg-transparent text-slate-700 placeholder:text-slate-400 focus:outline-none" />
              </div>
            </label>
            ...
            <label className="block">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm shadow-sm transition focus-within:border-pink-300 focus-within:ring-2 focus-within:ring-pink-100">
                <Lock className="h-5 w-5 text-slate-400" aria-hidden="true" />
                <input type={showConfirmPassword ? 'text' : 'password'} required placeholder="Konfirmasi password" className="w-full border-0 bg-transparent text-slate-700 placeholder:text-slate-400 focus:outline-none" />
                <button
                  type="button"
            ...
            <CustomButton type="button" title="Daftar" className="w-full py-3 text-base text-[#382b22]" onClick={() => router.push('/')} />

            <div className="flex items-center gap-4 text-xs uppercase tracking-wide text-slate-300">
              <span className="flex-1 border-t border-slate-200" />
              <span className="text-slate-400">Atau daftar akun dengan</span>
              <span className="flex-1 border-t border-slate-200" />
            </div>
            ...
            >
              ...
              <span className="text-center">Daftar dengan Google</span>
