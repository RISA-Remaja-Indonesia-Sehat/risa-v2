module.exports=[20226,a=>{"use strict";a.s(["create",()=>e],20226);var b=a.i(72131);let c=a=>{let b,c=new Set,d=(a,d)=>{let e="function"==typeof a?a(b):a;if(!Object.is(e,b)){let a=b;b=(null!=d?d:"object"!=typeof e||null===e)?e:Object.assign({},b,e),c.forEach(c=>c(b,a))}},e=()=>b,f={setState:d,getState:e,getInitialState:()=>g,subscribe:a=>(c.add(a),()=>c.delete(a))},g=b=a(d,e,f);return f},d=a=>{let d=(a=>a?c(a):c)(a),e=a=>(function(a,c=a=>a){let d=b.default.useSyncExternalStore(a.subscribe,b.default.useCallback(()=>c(a.getState()),[a,c]),b.default.useCallback(()=>c(a.getInitialState()),[a,c]));return b.default.useDebugValue(d),d})(d,a);return Object.assign(e,d),e},e=a=>a?d(a):d},94427,a=>{"use strict";a.s(["default",()=>d]);var b=a.i(20226);let c=[{id:1,title:"HIV? Gak Usah Panik, Yuk Kenalan Dulu!",img:"/image/article-image-1.png",imgAlt:"HIV Illustration",description:"Kenalan sama HIV biar gak salah paham dan tetap bisa jaga diri.",opinion:`
    ...
    `}],d=(0,b.create)((a,b)=>({articles:c,getArticleById:a=>c.find(b=>b.id===parseInt(a)),getAllArticles:()=>c}))},75697,a=>{"use strict";a.s(["default",()=>g],75697);var b=a.i(87924),c=a.i(71987),d=a.i(38246);function e({article:a}){return a?(0,b.jsx)("div",{className:"bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-pink-200 transition-all duration-300 group",children:(0,b.jsxs)(d.default,{href:`/article/${a.id}`,className:"block",children:[(0,b.jsx)("div",{className:"aspect-video overflow-hidden",children:(0,b.jsx)(c.default,{src:a.img,alt:a.imgAlt,width:400,height:225,className:"w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"})}),(0,b.jsxs)("div",{className:"p-6",children:[(0,b.jsx)("h3",{className:"font-bold text-lg text-gray-800 mb-3 group-hover:text-pink-600 transition-colors",children:a.title}),(0,b.jsx)("p",{className:"text-gray-600 text-sm leading-relaxed",children:a.description}),(0,b.jsxs)("div",{className:"mt-4 flex items-center text-pink-500 text-sm font-medium",children:["Baca Selengkapnya",(0,b.jsx)("span",{className:"ml-2 group-hover:translate-x-1 transition-transform",children:"→"})]})]})]})}):(0,b.jsx)("div",{className:"text-center py-10",children:"Tidak ada artikel tersedia."})}var f=a.i(94427);function g(){let{getAllArticles:a}=(0,f.default)(),c=a();return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)("section",{className:"bg-gradient-to-br from-pink-50 to-purple-50 py-16",children:(0,b.jsxs)("div",{className:"container mx-auto px-6 text-center",children:[(0,b.jsx)("h1",{className:"text-4xl md:text-5xl font-bold text-gray-800 mb-4",children:"Artikel & Topik 📚"}),(0,b.jsx)("p",{className:"text-lg text-gray-600 max-w-2xl mx-auto",children:"Temukan berbagai artikel menarik tentang kesehatan reproduksi yang ditulis khusus untuk remaja seperti kamu!"})]})}),(0,b.jsxs)("section",{className:"container mx-auto px-6 py-12",children:[(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("h2",{className:"text-2xl font-bold text-gray-800 mb-2 flex items-center",children:[(0,b.jsx)("span",{className:"text-3xl mr-3",children:"✨"}),"Yang Baru-Baru Ini Ada di Halaman Utama"]}),(0,b.jsx)("div",{className:"w-20 h-1 bg-pink-500 rounded"})]}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:c.map(a=>(0,b.jsx)(e,{article:a},a.id))})]})]})}}];

//# sourceMappingURL=_8f74ad42._.js.map